...
class BaseStorageService {
     ...
     */
    get(key, decoder) {
        const /** @type {?} */ value = this.getItem(key);
...
class NumberStorageTranscoder {
     ...
     */
    decode(value) {
        const /** @type {?} */ parsedNumber = Number(value);
...
function isStorageAvailable(storage) {
    ...
    try {
        ...
        const /** @type {?} */ testItemKey = `storage-test-entry-${now}`;
        const /** @type {?} */ testItemValue = `storage-test-value-${now}`;
        storage.setItem(testItemKey, testItemValue);
        const /** @type {?} */ retrievedItemValue = storage.getItem(testItemKey);
...
export { BaseStorageService, InMemoryStorageService, ProxyStorageService, JsonStorageTranscoder, StringStorageTranscoder, BooleanStorageTranscoder, NumberStorageTranscoder, StorageTranscoders, WebStorageService, isStorageAvailable, SESSION_STORAGE, LOCAL_STORAGE, sessionStorageFactory, localStorageFactory, StorageServiceModule };
